...
/**
 * Stub handler for GitHub webhooks (T2.1). Acting on the business meaning of an event
 ...
 */
final class GitHubHandler implements Handler
{
    public function handle(WebhookEvent $event): void
    {
        // Intentionally empty: the GitHub business logic is out of scope for T2.1.
    }
