...
/**
 * Stub handler for Stripe webhooks (T2.1). Acting on the business meaning of an event
 ...
 */
final class StripeHandler implements Handler
{
    public function handle(WebhookEvent $event): void
    {
        // Intentionally empty: the Stripe business logic is out of scope for T2.1.
    }
